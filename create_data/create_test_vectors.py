...
def main():
    ...
    mean_matrices['sad'] = np.load('/Users/omerhazan/Desktop/personal/studies/image '
                                   'processing/image_processing_project/PCA/eigen_matrices'
                                   '/scored_eigen_matrices'
                                   '/sad_mean_matrix.npy')
    weight_matrices['surprised'] = np.load('/Users/omerhazan/Desktop/personal/studies/image '
                                           'processing/image_processing_project/PCA/eigen_matrices'
                                           '/scored_eigen_matrices/surprised_matrix.npy')
    mean_matrices['surprised'] = np.load('/Users/omerhazan/Desktop/personal/studies/image '
                                         'processing/image_processing_project/PCA/eigen_matrices'
                                         '/scored_eigen_matrices/surprised_mean_matrix.npy')
    for emotion in emotions:
        folder_path = f'/Users/omerhazan/Desktop/personal/studies/image ' \
                      f'processing/image_processing_project/archive/test/{emotion}_sorted_hist_eq_mean_0.5'
        output_folder = f'/Users/omerhazan/Desktop/personal/studies/image ' \
                        f'processing/image_processing_project/PCA/testing_vectors_scored/{str(labels_dict[emotion])}_{emotion}_faces'
